...
var ViewProducts = {
	...
	view: function(ctrl, args){
		return {tag: "main", attrs: {className:"view-products is-visible"}, children: [
					...
					m.component(ProductList, {cols:4, products:args.products})
				]}
	}
}
						...
						for (i = 0; i < prods.length/cols; i++) {
							fillers.push(
								{tag: "div", attrs: {class:"product-list-item"}, children: [
									...
									{tag: "div", attrs: {class:"product-list-item-title"}, children: ["filler"]}, 
									{tag: "div", attrs: {class:"product-list-item-options"}, children: [
										{tag: "div", attrs: {class:"product-list-item-price"}, children: ["filler"]}, 

...
var ProductList = {
	controller: function() {
			return {
				listProducts: function(rows, products) {
					var view = [];

					for (var i = 0; i < rows.length; i++) {
						view.push({tag: "main", attrs: {class:"product-list"}, children: [
				 			{tag: "div", attrs: {class:"product-list-row"}, children: [
					...
					var products = products.map(function(item, index){
		...
		view: function(ctrl, args) {
	 		...
	 		return {tag: "main", attrs: {class:"product-list"}, children: [
	 			{tag: "div", attrs: {class:"product-list-row"}, children: [
					{tag: "div", attrs: {class:"grid-full mod-flex mod-space-between"}, children: [
	 					ctrl.listProducts(args.rows, args.products)
	 				]}
	 			]}
	 		]}	
		}
